var htmx = function() {
    ...
    function P(e) {
        ...
        if (n === "html") {
            ...
            const i = I('<body><template class="internal-htmx-wrapper">' + t + "</template></body>");
    ...
    function qe(i, e, s) {
        ie(e.querySelectorAll("[id]"), function(t) {
            ...
            if (n && n.length > 0) {
                const e = p(i);
                const r = e && e.querySelector(CSS.escape(t.tagName) + "#" + CSS.escape(n));
                if (r && r !== e) {
                    const o = t.cloneNode();
                    Ce(t, r);
    ...
    function tt(e, t, n) {
        return Ke.exec(e.charAt(0)) && e !== "true" && e !== "false" && e !== "this" && e !== n && t !== "."
    }
    ...
    function at(t, n, e) {
        if (t instanceof HTMLAnchorElement && ct(t) && (t.target === "" || t.target === "_self") || t.tagName === "FORM" && String(ee(t, "method")).toLowerCase() !== "dialog") {
            n.boosted = true;
            let r, o;
            if (t.tagName === "A") {
                r = "get";
    ...
    function an(e, t) {
        ...
        if (n.willValidate) {
            ...
            if (!n.checkValidity()) {
                if (ae(n, "htmx:validation:failed", {
                        message: n.validationMessage,
                        validity: n.validity
                    }) && !t.length && Q.config.reportValidityOfForms) {
                    n.reportValidity()
                }
                t.push({
                    elt: n,
    ...
    function Wn() {
        if (Q.config.includeIndicatorStyles !== false) {
            ...
            te().head.insertAdjacentHTML("beforeend", `<style${e}>` + `.${t}{opacity:0;visibility: hidden} ` + `.${n} .${t}, .${n}.${t}{opacity:1;visibility: visible;transition: opacity 200ms ease-in}` + "</style>")
        }
    }
